  ...
  return (
    <section id="feeds">
      <div class="container text-center">
        ...
        <div class="border rounded p-3 bg-white shadow row">
          <div class="col-md-4 p-3">
            <img
              src="images/feeds/undraw_Credit_card_re_blml.png"
              alt="Card Payment"
            ...
            <p class="lead text-left text-md-left">
              We make event registration easy with our secure payment processing
              system. We accept all major credit and debit cards, so you can
              quickly and securely pay for your event registration without any
              hassle.
            </p>
          </div>
          <div class="col-md-4 p-3">
            <img
              src="images/feeds/undraw_Around_the_world_re_n353.png"
              alt="Card Payment"
              class="img-fluid d-none d-md-inline"
              id="feeds-image"
            />
          ...
          <div class="col-md-4 p-3">
            <img
              src="images/feeds/undraw_Mobile_pay_re_sjb8.png"
              alt="Card Payment"
              class="img-fluid d-none d-md-inline"
              id="feeds-image"
            />
